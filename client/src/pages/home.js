...
const Home = () => {
    const [selfieimage, setSelfieImage] = useState({ preview: "", raw: "" });
            ...
            <div className="row">
                <div className="col-sm-4">
                    <div className="image-load selfie-img">
                        {
                            selfieimage.preview ? (<>
                                ...
                                {
                                    selectedFrame ? (<><img src={selfieimage.preview} alt="dummy" width="90%" height="97%" /><img className="selected-frame" src={selectedFrame} alt="dummy" width="100%" height="100%" /></>) : (<img src={selfieimage.preview} alt="dummy" width="100%" height="100%" />)
                                }
                            </>
                            ) : (<></>)
                        }
                    ...
                    <div className="d-flex">
                        <input type="file" name="Choose Files" accept="image/png, image/gif, image/jpeg" onChange={changeSelfieHandler} />
